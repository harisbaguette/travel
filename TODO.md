...
> 배포: https://pinjido.vercel.app (핀지도. pinmap·tripmap·tripin은 남이 선점.
> 예전 주소 travel-pq·travel-pin-kr·travel-chi-lilac도 같은 앱으로 계속 동작)
...
- **구글 지도 단일화(2026-08-08)** — 무료 지도(OpenFreeMap/OSM) 제거, 구글 타일을
  열쇠 없이 기본으로. 열쇠가 있으면 공식 구글 지도. 검색도 구글 우선(무열쇠 embed 파싱,
  `/api/search-place`) → 주소 사전은 예비.
...
- 검색 — 동남아 도시 표 + 구글 무열쇠 검색 우선, Photon/Nominatim은 예비 폴백.
